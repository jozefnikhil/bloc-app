...
mixin _$FastLaughState {
  List<Downloads5> get videoList => throw _privateConstructorUsedError;
...
abstract class $FastLaughStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Downloads5> videoList, bool isLoading, bool isError});
}
...
class _$InitialImpl implements _Initial {
  const _$InitialImpl(
      {required final List<Downloads5> videoList,
      required this.isLoading,
      required this.isError})
      : _videoList = videoList;

  final List<Downloads5> _videoList;
  @override
  List<Downloads5> get videoList {
