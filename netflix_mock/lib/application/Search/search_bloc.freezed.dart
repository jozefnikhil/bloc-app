...
/// @nodoc
mixin _$SearchState {
  List<Content> get searchResultList => throw _privateConstructorUsedError;
  List<Downloads5> get idleList => throw _privateConstructorUsedError;
...
abstract class $SearchStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<Content> searchResultList,
      List<Downloads5> idleList,
      bool isLoading,
      bool isError});
}
...
class _$SearchStateImpl implements _SearchState {
  const _$SearchStateImpl(
      {required final List<Content> searchResultList,
      required final List<Downloads5> idleList,
      required this.isLoading,
      required this.isError})
      : _searchResultList = searchResultList,
        _idleList = idleList;

  final List<Content> _searchResultList;
  @override
  List<Content> get searchResultList {
  ...
  final List<Downloads5> _idleList;
  @override
  List<Downloads5> get idleList {
