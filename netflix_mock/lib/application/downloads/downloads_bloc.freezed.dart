...
mixin _$DownloadsState {
  ...
  List<Downloads5>? get downloads => throw _privateConstructorUsedError;
  Option<Either<MainFailure, List<Downloads5>>>
    ...
    return _then(_value.copyWith(
      ...
      downloadsFailureOrSuccessOption: null == downloadsFailureOrSuccessOption
          ...
          : downloadsFailureOrSuccessOption // ignore: cast_nullable_to_non_nullable
              as Option<Either<MainFailure, List<Downloads5>>>,
    ) as $Val);
  }
}
...
class _$DownloadsStateImpl implements _DownloadsState {
  const _$DownloadsStateImpl(
      ...
      required final List<Downloads5>? downloads,
      required this.downloadsFailureOrSuccessOption})
      : _downloads = downloads;

  @override
  final bool isloading;
  final List<Downloads5>? _downloads;
  @override
  List<Downloads5>? get downloads {
  ...
  @override
  final Option<Either<MainFailure, List<Downloads5>>>
      downloadsFailureOrSuccessOption;
...
abstract class _DownloadsState implements DownloadsState {
  const factory _DownloadsState(
      ...
      required final List<Downloads5>? downloads,
      required final Option<Either<MainFailure, List<Downloads5>>>
